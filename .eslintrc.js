module.exports = exports =
{
  ...
  'rules': {
    ...
    'keyword-spacing': [1, {'before': true, 'after': true}], // enforces spacing between keywords
    ...
    'space-before-function-paren': [1, {'anonymous': 'always', 'named': 'always'}], // require or disallow space before function opening parenthesis
    ...
    'max-len': [1, 125, 2], // specify the maximum length of a line in your program (off by default)
    ...
    'react/jsx-wrap-multilines': 2, // Wrapping multiline JSX in parentheses can improve readability
